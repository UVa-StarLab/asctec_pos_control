...
ros::Subscriber traj_rec;

pc_asctec_sim::pc_traj_cmd traj_cmd;

void traj_callback(const std_msgs::Empty::ConstPtr& msg) 
{
	ROS_INFO("Publishing new trajectory");
...
int main(int argc, char** argv) {
	...
	traj_rec = nh.subscribe<std_msgs::Empty>(quad_name + "/traj_end", 10, traj_callback);
